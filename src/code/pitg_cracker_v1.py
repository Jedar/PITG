...
def main():
    ...
    inputs = "/disk/data/targuess/3_query/Collection_fr_10k.csv"
    result_save = "/disk/yjt/PersonalTarGuess/result/csv/pitg/t_collection_4kw_q_Collection_fr_10k_m_region_v2_combine.csv"
